...
`2020-today`
**Lab Manager at Bochum Makerspace** - I manage two sub-labs (IT / integrated electronics and plastics fabrication) and I'm involved in the overall development / management of [RUB-Makerspace](https://makerspace.rub.de), a 2000sqm innovation space with a team of 15 people. *Ruhr-Universität Bochum*, Germany.
...
**Making** - Rapid Prototyping (many different methods), CAD/CAM, general (basic) coding, (traditional) web development, electronics and integrated systems for rapid prototyping.
...
**Methods** - Constructionism, human-centered teaching and learning, mixed-methods, action and field research, participatory methods and participatory action research, (Maker-)space(s) as a method. Makerspace operation / management / funding / development / safety.
