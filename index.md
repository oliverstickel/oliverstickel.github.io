...
`2013-2019`
**Founder and manager**. I founded [Fab Lab Siegen](https://fablab-siegen.de) and managed it on its journey from a student initiative in a literal storage room on campus outside the city to a big, wonderful, colorful, open and community-oriented space with a funded team and filled with people, ideas, tools and machines right in the city center. *Siegen*.
